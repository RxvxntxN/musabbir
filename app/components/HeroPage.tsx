    ...
    <div className="flex flex-col md:flex-row h-screen">
      <div className="flex-1 flex justify-center items-center p-4 md:pl-10 order-1 md:order-1">
        <div className=" md:space-y-6 text-center w-lg md:text-left">
          <h1 className="text-black text-4xl md:text-6xl font-bold font-alegreya">
            Hello, I&apos;m Musabbir
          </h1>
          ...
          <div className="pt-2">
            <Link href={'/explore-more'}>
              <button className="px-6 py-2 border-2 border-teal-500 text-black rounded-md hover:bg-teal-500 hover:text-white transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:ring-opacity-50">
                Explore More
              </button>
            </Link>
          </div>
